    ...
    <>
      ...
      <div className="pt-4 w-full min-h-screen bg-gray-200">
        ...
        <div className="px-6 container mx-auto">
          ...
          <p>
            At <strong>SmartSummary</strong>, accessible from{" "}
            <a
              href="" //1
              className="text-indigo-700 font-bold"
            >
              {/* us link ko likhna h jo 1 par save hoga */}
            </a>
            , one of our main priorities is the privacy of our visitors. This
            Privacy Policy document contains types of information that is
            collected and recorded by SmartSummary and how we use it.
          </p>
          ...
          <p>
            ...
            <a
              href=""//gmail banani h 2
              className="text-indigo-700 font-bold"
            >
              {/* gmalil ko yha likhna h */}
            </a>
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in SmartSummary. This policy is not
          ...
          <p>
            SmartSummary follows a standard procedure of using log files. These
          ...
          <p>
            ...
            advertising partners of SmartSummary.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on SmartSummary,
          ...
          <p>
            Note that SmartSummary has no access to or control over these
          ...
          <p>
            SmartSummary's Privacy Policy does not apply to other advertisers or
          ...
          <p>
            SmartSummary does not knowingly collect any Personal Identifiable
